...
{% tabs %}
{% tab title="ROS.org" %}
[http://wiki.ros.org/catkin/Tutorials/create\_a\_workspace](http://wiki.ros.org/catkin/Tutorials/create\_a\_workspace)
{% endtab %}
{% endtabs %}
...
* 상기와 같이 설정하신 후 아래의 명령어를 터미에 입력하여 변경된 부분들을 원격 PC 에 업데이트 합니다.
